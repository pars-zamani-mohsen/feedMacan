...
return [
    ...
    */
    'bots'                         => [
        'mybot' => [
            'username'            => 'Parspendarbot',
            'token'               => env('TELEGRAM_BOT_TOKEN', '403759168:AAFgipfeCt7PEBmZB4h13aYoqvjM4UsUqFI'),
            'certificate_path'    => env('TELEGRAM_CERTIFICATE_PATH', 'YOUR-CERTIFICATE-PATH'),
            'webhook_url'         => env('TELEGRAM_WEBHOOK_URL', 'https://feed.macan.ir/_telegram'),
            'commands'            => [
